...
Copy the filebeat config files to the Elk VM.
Update the hosts file to the correct IP which is located in the (/etc/ansible/) refer to the following the screenshot below:
